...
var hum_graph = d3.select("#hum_chart").append("svg")
...
d3.json("hum2json.php", function(error, data) 
{
      ...
      .on('mouseover', function (d, i) 
        {
          div.transition()
               .duration("200")
               .style("opacity", 1);
          div.html("("+d3.format(".1f")(d.humidity)+" %)   @" + d.timestamp)
  ...
  hum_graph.selectAll("rect")
      .transition()
      .duration(4000)
      .attr("y", function(d) { return y(d.humidity); })
      .attr("height", function(d) { return height - y(d.humidity); })
